...
const USAGE = `Usage:
  node generate-listings-csv.js \\
    --org <alias> --base-url <url> --prefix <name> [options]

Required:
  --org <alias>           SF CLI target org alias (e.g., andersentest)
  --base-url <url>        Storefront base URL (no trailing slash)
  --prefix <name>         Output filename prefix

Options:
  --webstore-name <name>  WebStore Name to look up (default: "Andersen Parts Store")
...
function parseArgs(argv) {
  const out = {
    ...
    baseUrl: null,
    prefix: null,
    webstoreName: 'Andersen Parts Store',
